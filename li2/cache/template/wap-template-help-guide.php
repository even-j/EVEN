        ...
        <div class="bar">
            <div class="aboutM">
                <style>
                    ...
                    .pg-guide-item h4 { margin-left: -16px; color: #fff }
                    .pg-guide-item h4 span { display: inline-block; min-width: 145px; padding:10px 16px; }
                        ...
                        <div id="stock" class="pg-guide-info mt20">
                            ...
                            <div class="pg-guide-item dark">
                                ...
                                <div class="pl40 pr40">
                                    <dl>
                                        <dt></dt>
                                        <dd>股票策略是一种创新的股票投资工具，通过股票策略，能有效的提高投资收益，堪称炒股利器。在系统性或确定性机会出现时，投资者运用策略工具，可以在华亿策略获得自有资金1-10倍的实盘资金，能够将收益放大到10倍。投资者需要注意，策略工具在放大收益也会放大风险，投资者应在投资机会比较确定并管理好风险的前提下使用，选择相对稳健的品种。</dd>
                                    </dl>
                                </div>
                            </div>
                            <div class="pg-guide-item">
                                ...
                                <div class="pl40 pr40">
                                    <dl>
                                        <dt></dt>
                                        <dd>策略成功后，华亿策略平台会为客户在合作券商处分配股票交易实盘账户，用户可在我的账户 >> 操盘管理 >> 按天/按月策略的目录下查看证券账号和交易密码。（首次策略用户必须点击下载“交易软件”才可以开始交易）。</dd>
                                    </dl>
                                </div>
                                ...
                                <div class="pg-guide-item dark">
                                    ...
                                    <div class="pl40 pr40">
                                        <dl>
                                            <dt></dt>
                                            <dd>股票策略完成后，您获得一个证券公司的股票交易账号和密码，然后就可以开始交易了。为了保护策略资金安全，同时帮您养成良好的投资习惯，交易账户会设置警戒线和平仓线。亏损警告线：当总操盘资金低于警戒线（亏损至本金*60%）以下时，只能平仓不能建仓。亏损平仓线：当总操盘资金低于平仓线（亏损至本金*80%）以下时，系统将把您的股票进行平仓。为避免平仓发生，请时刻关注本金是否充足。如果未强平成功，继续亏损至本金*100%情况下，券商有权强制收回交易账号进行结算，穿仓部分客户无需赔偿。</dd>
                                        </dl>
                                    </div>
                                </div>
                                <div class="pg-guide-item">
                                ...
                                <div class="pg-guide-item dark">
                                    ...
                                    <div class="pl40 pr40">
                                        <dl>
                                            <dt></dt>
                                            <dd>操盘前必读
                                                <br/> 1、请尽量保持操盘保证金高于亏损警戒线，及时添加风险保证金，以免到达亏损平仓线被强制平仓；
                                                <br/> 股票停牌处理
                                                <br/> 如果您买的股票遇到停牌，可选择以下方法：
                                                <br/> (1)在策略期限到期前一天，按停牌股票市值追加20%作为停牌准备金，股票复牌后，如股票上涨，退还全部停牌保证金，下跌在停牌保证金里扣除下跌部分金额（剩余退还）
                                                <br/> (2)在到期前一天，选择以停牌前一交易日收盘价作为结算价格对停牌股票进行清算。
                                                <br/> 交易手续费
                                                <br/> 手续费包含印花税、过户费和交易佣金，印花税和过户费按财政部和交易所规定收取，交易佣金0.02%（万二）由券商收取。
                                                <br/> 其他注意事项
                                                <br/> 
                                                1、交易盈利部分可在平仓结算后随时提现，申请结算（工作时间内）及时到达您账户，如您申请提款到银行卡，工作时间及时到账（节假日无休）；
                                                <br/>
                                                2、按天策略支付管理费，如1月10日15:00前策略，系统当天扣除第1天管理费，1月11日自动（08:30分）扣除第二天管理费，以此类推；
                                                <br/>
                                                3、按月策略支付利息，如1月10日策略，当天扣除第1个月利息，2月11日支付第2个月利息，以此类推；
                                                <br/>
                                                4、策略到期前一个交易日，应将股票账号平仓，进行结算。如到期未结算，系统将自动延期收取对应费用。
                                            </dd>
                                        </dl>
                                    </div>
                                </div>
