...
<div id="base-info-bar">
    ...
    <div class="w1200">
        ...
        <div style="margin:0 auto;text-align: center;height: 350px;background-image: url('/public/web/images/ad_monthzg.png');background-repeat: no-repeat;background-position: center">
        </div>
            ...
            <div class="bgwhite" style="width:1090px; margin: 15px auto 0px auto; border:0; padding-top: 0;">
                ...
                <div style="width:100%; margin:0; padding:0; clear:both;">
                    <div style="width:495px; height:496px; padding-left:32px; float:left; border:1px solid #c2c2c2; display:block;">
                        ...
                        <h3 style="color:#ff6f06;font-size: 16px; margin-top: 35px; font-weight: bold;">第二步：<span style="font-weight: 400">选择获得资金（选择杠杆，资金放大5-10倍）</span></h3>
                        <ul class="chooseUlLi" style="margin: 48px 0 0 0!important">
                            <li>
                                <a class="active" href="javascript:">
                                    <i></i><strong>5</strong>倍
                                    <p style="font-size: 0.75em;">月利率<?php echo $params['manage_cost_money5']; ?>% </p>
                            ...
                            <li>
                                <a href="javascript:">
                                    ...
                                    <p style="font-size: 0.75em;">月利率<?php echo $params['manage_cost_money6']; ?>%</p>
                                    <p><span class="times" data-times="6">6000</span>元</p>
                                </a>
                            </li>
                            <li>
                                <a href="javascript:">
                                    <i></i><strong>7</strong>倍
                                    <p style="font-size: 0.75em;">月利率<?php echo $params['manage_cost_money7']; ?>%</p>
                                    <p><span class="times" data-times="7">7000</span>元</p>
                                </a>
                            </li>
                            <li>
                                <a href="javascript:">
                                    <i></i><strong>8</strong>倍
                                    <p style="font-size: 0.75em;">月利率<?php echo $params['manage_cost_money8']; ?>%</p>
                                    <p><span class="times" data-times="8">8000</span>元</p>
                                </a>
                            </li> 
                            <li>
                                <a href="javascript:">
                                    <i></i><strong>9</strong>倍
                                    <p style="font-size: 0.75em;">月利率<?php echo $params['manage_cost_money9']; ?>%</p>
                                    <p><span class="times" data-times="9">9000</span>元</p>
                                </a>
                            </li> 
                            <li>
                                <a href="javascript:">
                                    <i></i><strong>10</strong>倍
                                    <p style="font-size: 0.75em;">月利率<?php echo $params['manage_cost_money10']; ?>%</p>
                                    <p><span class="times" data-times="10">10000</span>元</p>
                                </a>
                            </li>
                        </ul>
                    </div>
                    <div style="width:520px; height:496px; padding-left:32px; float:right; border:1px solid #c2c2c2; display:block;">
                        ...
                        <p style="font-size: 16px;">
                            ...
                            <select id="tradecycle">
                                <option value="1">1个自然月</option><option value="2">2个自然月</option><option value="3">3个自然月</option><option value="4">4个自然月</option><option value="5">5个自然月</option><option value="6">6个自然月</option><option value="7">7个自然月</option><option value="8">8个自然月</option><option value="9">9个自然月</option><option value="10">10个自然月</option><option value="11">11个自然月</option><option value="12">12个自然月</option>                                </select>
                            <span style="margin-left:25px;">&nbsp;</span>
                            账户管理费：
                            <em id="accountManageFees">0</em>元 / 自然月
                        </p>
                        <p style="color:#8e8e8e; margin: 10px 0; font-size: 13px;">
                            备注：
                            按月收取管理费
        ...
        <div class="items">
            ...
            <ul>
                ...
                <li style="background-position:0px -64px;">收益最大可放大8倍</li>
            ...
            <div class="ddwdetail" style="clear:both">
                <h3>操盘须知</h3>
                <p>1、风险提示：股市有风险，投资需谨慎！华亿策略股票操盘操作中只收取利息，无其他任何费用。</p>
                <p>2、您的投资本金：您自己投资股票的资金，必须是1000的整数倍。</p>
                <p>3、资金使用期限：资金使用期限按自然月计算，如6月25日到7月25日（包含节假日）。</p>
                <p>4、每月利息支付：按月计算，每月利息先付后用，6月25日操盘，6月25日支付第一个月利息，7月25日支付第二个月利息，以此类推。</p>
        ...
        <script type="text/jscript">    
                ...
                $(function() {
                    ...
                    $('#initBtn').click(function() {
                        ...
                        window.location.href="<?php echo \App::URL('web/peiziu/peizi');?>&pz_type=2&money="+cpj+"&pz_ratio="+risk+"&times="+duration+params;
