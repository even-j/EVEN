    ...
    <li <?php if($_GET['mod']=='help' && $_GET['ac']=='software'){echo ' class="now"';}?>><a href="<?php echo \App::URL("web/help/software");?>" >APP下载</a></li>
            ...
            <div class="aboutMain">
                ...
                <div class="aboutM">
                    ...
                    <div class="helpbox">
                        <div style="display: block;" class="hbc">
                            <dl class="hover">
                                <dt>简单五步，申请策略轻松赚钱
                                    <a name="QA-2-1"></a>
                                </dt>
                                <dd>选择策略产品 &gt; 填写策略申请 &gt; 策略机构审核 &gt; 确认缴纳保证金 &gt; 获取交易账号炒股。</dd>
                                <dd>华亿策略提供三种策略产品：</dd>
                                <dd style="padding-left:20px">a、按月策略：每月按息付费产品，根据您想要策略的资金额度获取不同的每月利息，策略资金越高，每月利息越优惠。固定月息产品在策略开始时收取首月利息，不足一个月按照一个月缴纳。</dd>
                                <dd style="padding-left:20px">b、按天策略：根据您的喜好，选择不同的策略资金和保证金比例。资金使用期限最短2天，最长30天，每天支付管理费；策略到期默认每天自动延期，费用不足时自动终止。</dd>
                                <dd style="padding-left:20px">c、免费体验：您只需提供100元保证金，提供给您5000元的炒股账户2天。盈利归您，亏损算华亿策略，不需要任何费用。</dd>
                                <dd style="padding-left:20px">策略申请成功，可以在我的华亿策略会员中心管理我的策略订单，您可以追加实盘金或补充保证金。</dd>
                            </dl>
                            <dl>
                                <dt>如何进行策略炒股
                                    <a name="QA-2-2"></a>
                                </dt>
                                <dd>D、申请完策略后，您将获取炒股交易账号和密码，请根据提示到华亿策略会员中心下载股票交易端软件。策略炒股交易委托完全由您自己掌控。</dd>
                            </dl>
                            <dl>
                                <dt>策略利息多少，如何支付
                                    <a name="QA-2-4"></a>
                                </dt>
                                <dd>您在进行策略申请时，默认有配置机构的服务利息率，根据您策略资金的多少您的利息可能有所不同。每月利息提前支付，收息申请策略在申请时支付，以后每个月按照申请策略日期支付利息。</dd>
                            </dl>
                            <dl>
                                <dt>策略对购买股票的限制
                                    <a name="QA-2-6"></a>
                            ...
                            <dl>
                                ...
                                <dd>策略风控系数 = 账户总资产除以策略资金，如总资产为120万，策略资金为100万，则风控系数为120%。风控系数越大，说明你赚的钱越多或者您缴纳的保证越多，账户越安全。</dd>
                            </dl>
                            <dl>
                                <dt>什么是策略周期
                                    <a name="QA-2-8"></a>
                                </dt>
                                <dd>华亿策略提供三种类型的产品，不同类型产品对应的产品利息和周期有所不同，主要体现为：</dd>
                                <dd><strong>免费体验产品：</strong>该产品操盘人只需要递交100元保证金就可以获得5000元实盘资金，操盘时间为2天，当天买，第二天卖，所有盈利归操盘人；</dd>
                                <dd><strong>按天收息产品：</strong>该产品操盘人可以申请100元到500万元不等的操盘资金，最大杠杆系数为6倍，以按天支付策略管理费的方式操作。操盘时间为2天~30天，操盘结束，所有盈利归操盘人；</dd>
                                <dd><strong>按月付息产品：</strong>操盘人可以根据产品定义的资金范围，以100元整数倍进行策略，按月付息最低操作周期为一个月。</dd>
                            </dl>
                        </div>
                    </div>
                </div>
