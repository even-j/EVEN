...
<div class="container clearfix">
    <div class="main-wrap">
    	 <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/index.php?app=admin&mod=index&ac=view" target="_top">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/index.php?app=admin&mod=peizi&ac=free">结束策略</a><span class="crumb-step">&gt;</span><span><?php echo $nav_title;?></span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
             <form action="/index.php?app=admin&mod=peizi&ac=doFreeEdit" method="post" onclick="return validateForm();" id="myform" name="myform" enctype="multipart/form-data">
                 ...
                 <table class="insert-tab" width="100%">
                    <tbody>
                        ...
                        <tr>
                            <th>结束时间：</th>
                            <td><?php echo date('Y-m-d',$pz_row['end_time']);?></td>
                        </tr>
                        <tr>
                            <th>证券账户：</th>
                        ...
                        <tr>
                            <th>风险警戒线：</th>
                            <td id='bond_total'><?php echo floatval($pz_row['alarm_money'])/100 ?></td>
                        </tr>
                        <tr>
                            <th>平仓止损线：</th>
                            <td id='bond_total'><?php echo floatval($pz_row['stop_money'])/100 ?></td>
                        </tr>
                        <tr>
                            <th>实盘单号：</th>
...
<script type="text/javascript">
    function balance_change(obj){
        ...
        //总盈亏
        var profit_loss_money = parseFloat($(obj).val())- parseFloat( $('#trade_money_total').html())-parseFloat($('#fill_loss_money').html());
...
function goback(){
    var url = '/index.php?app=admin&mod=peizi&ac=free';
