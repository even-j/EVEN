...
<script src="/public/wap/js/common.js" type="text/javascript"></script>
        ...
        <script>
            ...
            function get_data(){
                ...
                $.post("<?php echo \App::URL('wap/user/tuiguang_recharge_data');?>",{page : page,begindate:begindate,enddate:enddate},function(data){
                    $("#record").append(data);
                    if(pagesize*page >= rowcount){
                        $("#btn_more").hide();
                    }
    ...
    <body class="index">
        ...
        <div class="ms-c6-t">
         ...
         <div class="space-main clearfix">
            <div class="ms-c6">
                <form action="<?php echo \App::URL('wap/user/tuiguang_recharge');?>" method="get">
