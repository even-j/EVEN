                ...
                <div class="space-main clearfix">
                    ...
                    <div class="space-right">
                        ...
                        <div class="ms-c6">
                            ...
                            <div class="ms-c6-m">
                                <form action="<?php echo \App::URL('web/user/tuiguang_withdraw');?>" method="get">
                                ...
                                <div class="ms-c6-table clearfix">
                                    <table>
                                        ...
                                        <?php } ?>
                                        <tr>
                                                <td class="w120"><span><?php echo isset($total[0]) ?$total[0]['true_name']:''; ?></span></td>
                                                <td class="w120"></td>
