            ...
            <div class="borBox" id="regBox" style="margin: 30px 0px; padding: 10px 20px; border-radius: 5px;background-color: #ffffff;">
                <form id="registerForm" method="post">
                    ...
                    <dl class="form">
                        ...
                        <dt>图形验证码：</dt>
                        <dd><input class="text" type="text" value="1111" name="authcode" id="authcode" autocomplete="off"/>
                            <img class="yzmPic codeimg" src="<?php echo \App::URL('web/member/makeCertPic')?>" onclick="this.src='/index.php?app=web&mod=member&ac=makeCertPic'" /><span><i id="ua"></i></span></dd>
                        </div>
                        
                        <dt>手机验证码：</dt>
                        <dd><input class="text" type="text" name="smscode" id="smscode" autocomplete="off"  placeholder="请输入验证码" />
                            <!-- <img class="yzmPic codeimg" src="<?php echo \App::URL('web/member/makeCertPic')?>"  /> -->
                            <input class="btn btnBg3 smscode" id="sendAuthBtn" data="bind" type="button" type="text" value="验证码：265751" />
                            <!-- <input class="btn btnBg3 smscode" id="sendAuthBtn" data="bind" type="button" type="text" value="获取验证码" /> -->
                            <!-- <span class="tip" id="ia" data="验证码必须为4位数字">输入手机收到的验证码</span> -->
                        </dd>
                        <dt>设置密码：</dt>
