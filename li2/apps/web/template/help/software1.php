...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <style>
            ...
            .down_img li{float:left;width:24%;height:200px;margin:10px 13%;position: relative}
            .down_img li img{width:100%}
            .down_img li .ewm{position: absolute;top:42px;left:4px;width: 180px;}
        </style>
    </head>
        ...
        <div class="bar">
            ...
            <div class="aboutMain" style="">
                ...
                <div class="aboutM"><script type="text/javascript">
                    ...
                    <div class="helpbox">
                        <div style="padding-top:40px;height:500px;display:block;background: url('/public/web/images/down/pc_bg.png') no-repeat center bottom" class="hbc">
                            <img src="/public/wap/images/down/app_text_02.png" style="display:block;margin:0px auto;height: 40px"/>
                            <ul class="down_img">
                                <li><img src="/public/web/images/down/and_icon.png"/>
                                    <img class="ewm" src="/public/wap/images/down/ewm_peizi.png?v=2"/>
                                </li>
                                <li><img src="/public/web/images/down/ios_icon.png"/>
                                <img class="ewm" src="/public/wap/images/down/ewm_peizi.png?v=2"/></li>
                            </ul>
                ...
                <p><span>1</span>点击“华亿策略”弹出下面对话框！</p>
                <img src="public/wap/images/down/p01.png?v=1" style="margin-left:50px"/>        	
                <p><span>2</span>点击“设置”！</p>
                <img src="public/wap/images/down/p02.png?v=1" style="margin-left:50px"/>
                <p><span>3</span>点击“通用”！</p>
                <img src="public/wap/images/down/p03.png?v=1" style="margin-left:50px"/>
                <p><span>4</span>点击“设备管理”！</p>
                <img src="public/wap/images/down/p04.png?v=1" style="margin-left:50px"/>
                <p><span>5</span>点击“企业级应用”-“...”！</p>
                <img src="public/wap/images/down/p05.png?v=1" style="margin-left:50px"/>
                <p><span>6</span>点击“信任...”！</p>
                <img src="public/wap/images/down/p06.png?v=1" style="margin-left:50px"/>
                <p><span>7</span>点击“信任”</p>
                <img src="public/wap/images/down/p07.png?v=1" style="margin-left:50px"/>
                <p><span>8</span>完成操作，可以正常使用“华亿策略”了！</p>
            </div>
