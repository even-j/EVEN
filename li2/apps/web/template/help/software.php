...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body class="index">
        ...
        <div class="bar">
                ...
                <div class="aboutM"><script type="text/javascript">
                    ...
                    <div class="helpbox">
                        <div style="padding-top:40px;height:550px;display:block;background: url('/public/web/images/down/pc_bg.png') no-repeat;background-size: 100% 100%" class="hbc">
                            ...
                            <ul class="down_img">
                                <li>
                                    <a href="/华亿电脑端.exe"><img src="/public/web/images/down/win_icon.png"/></a>
                                </li>
                                <li><img src="/public/web/images/down/and_icon.png"/>
                                    <img class="ewm" src="<?php echo $params_ewm['peiziapp_path'];?>"/>
                                </li>
                                <li><img src="/public/web/images/down/ios_icon.png"/>
                                    <img class="ewm" src="<?php echo $params_ewm['peiziapp_path'];?>"/></li>
                            </ul>
                ...
                <p><span>1</span>点击“华亿平台”弹出下面对话框！</p>
                ...
                <p><span>8</span>完成操作，可以正常使用“华亿平台”了！</p>
            </div>
