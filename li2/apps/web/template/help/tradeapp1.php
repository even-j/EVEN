                ...
                <div class="aboutM"><script type="text/javascript">
                    ...
                    <div class="helpbox">
                        <div style="padding-top:40px;height:550px;display:block;background: url('/public/web/images/down/pc_bg.png') no-repeat;background-size: 100% 100%" class="hbc">
                            ...
                            <ul class="down_img">
                                <li>
                                    <a href="http://www.hypz.cn/华亿交易端.exe"><img src="/public/web/images/down/win_icon.png"/></a>
                                </li>
                                <li><img src="/public/web/images/down/and_icon.png"/>
                                    <img class="ewm" src="/public/wap/images/down/733a.png?v=2"/>
                                </li>
                                <li><img src="/public/web/images/down/ios_icon.png"/>
                                    <img class="ewm" src="/public/wap/images/down/733i.jpg?v=2"/></li>
                            </ul>
                            

                        </div>
                        <dd><strong>电脑端下载说明：</strong></dd>
                        <dd>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;①点击“电脑版下载”或“<a target="_blank" href="华亿交易端.exe"> http://www.hypz.cn/华亿交易端.exe</a>”将安装包下载到桌面；</dd>
