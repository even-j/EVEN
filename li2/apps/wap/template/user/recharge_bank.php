...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body class="index">
        ...
        <ul class="account">
            <li>公司名称：广州栋供科技有限公司<span id="copy_name">复制</span></li>
            <li>公司账号：44050164643900000374<span id="copy_no">复制</span></li>
            <li>开户地址：中国建设银行股份有限公司广州上冲支行</li>
        </ul>
        <p style="font-size:12px;color:#777;padding:10px 15px">填写付款信息</p>
        <ul class="list">
            <li>
                <p>转账金额</p>
                <input id="money" type="text" placeholder="请输入要转账的金额"/>
            </li>
            <li>
                <p>汇款人姓名</p>
                <input id="name" type="text" placeholder="请输入汇款人姓名"/>
            </li>
        </ul>
