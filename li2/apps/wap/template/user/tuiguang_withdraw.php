    ...
    <head>
        ...
        <script>
            ...
            function get_data(){
                ...
                $.post("<?php echo \App::URL('wap/user/tuiguang_withdraw_data');?>",{page : page,begindate:begindate,enddate:enddate},function(data){
                    $("#record").append(data);
                    if(pagesize*page >= rowcount){
                        $("#btn_more").hide();
                    }
    ...
    <body class="index">
        ...
        <div class="ms-c6-t">
         ...
         <div class="space-main clearfix">
            <div class="ms-c6">
                <form action="<?php echo \App::URL('wap/user/tuiguang_withdraw');?>" method="get">
                    <input name="app" value="wap" type="hidden"/>
                    <input name="mod" value="user" type="hidden"/>
                    <input name="ac" value="tuiguang_withdraw" type="hidden"/>
                ...
                <table>
                    <tbody id="record">
                        <tr>
                            ...
                            <th class="w200">提现人</th>
                            <th class="w200">提现金额</th>
                            <th class="w120">时间</th>
                        </tr>
                        <tr>
                ...
                <div id="btn_more" onclick="get_data();" style="width:60px;height:20px;line-height: 20px;background: #ddd;text-align: center;font-size: 12px;margin: 10px auto">更多111...</div>
                <?php }else{ ?>
                <div class="emptydata">
                    <p>呃...没有记录!</p>
                </div>
