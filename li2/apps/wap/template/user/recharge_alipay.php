...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body class="index">
        ...
        <ul class="account">
            <li>1.点击“复制”支付宝账号充值：</li>
            <li>
                <p>公司名称：广州栋供科技有限公司</p>
                <p>支付宝账号：<span style="color:red;padding-left:0px">yhpz88@126.com</span><span id="copy_account">复制</span></p>
            </li>
            <li>2.截屏保存扫描二维码充值：</li>
            <li>
                <p style="text-align:center;text-indent: 0px">
                    <img src="/public/wap/images/alipay.png" width="160" />
                </p>
