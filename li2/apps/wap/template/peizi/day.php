        ...
        <div style="padding:0px 20px;">
            ...
            <div class="ddw_l" id="money_input">
                <div class="mt10" style="position:relative;">
                    <input name="zhi" id="money" type="text" class="ui-input" value="" placeholder="<?php echo $params['minLimitMoney']/100?>~<?php echo $params['maxLimitMoney']/10000/100?>万" style="height:40px; line-height:40px; width:98%; text-align:center;font-size: 16px;border-radius: 3px;border: 1px solid #ccc;">
                    <div style="width:50px; line-height:38px; height:30px; position:absolute;right:5px; _right:25px; top:3px; _top:6px;">元 </div>
                </div>
            </div>
            <p class="wap_ddw_l">2.选择杠杆，资金放大1-6倍</p>
            <div id="div_risk">
                <ul class="clearfix">
                    <li class="active" data-times="1">
                        <strong>1</strong>倍
                        <p>日利率 <?php echo $params['manage_cost_money1']; ?>%</p>
                    </li>
                    <li data-times="2">
                        <strong>2</strong>倍
                        <p>日利率 <?php echo $params['manage_cost_money2']; ?>%</p>
                    </li>
                    <li data-times="3">
                        <strong>3</strong>倍
                        <p>日利率 <?php echo $params['manage_cost_money3']; ?>%</p>
                    </li>
                    <li data-times="4">
                        <strong>4</strong>倍
                        <p>日利率 <?php echo $params['manage_cost_money4']; ?>%</p>
                    </li>
                    <li data-times="5">
                        <strong>5</strong>倍
                        <p>日利率 <?php echo $params['manage_cost_money5']; ?>%</p>
                    </li>
                    <li data-times="6">
                        <strong>6</strong>倍
                        <p>日利率 <?php echo $params['manage_cost_money6']; ?>%</p>
                    </li>
            ...
            <span>期限：</span>
            <select id="duration" class="sel-b" name="duration" style="width:80px;height:26px;font-size: 14px">
            ...
            <div style="padding:0 10px" >
                ...
                <div style="padding:0px 0px;">
                    ...
                    <div class="txt-c pdd_20 pt20" style="margin-top:20px">
...
//                    }
                ...
                $('#subBtn').click(function() {
                    ...
                    $.post(url,{deposit:deposit,duration:duration,pz_ratio:risk,pz_type:1,trade_time : trade_time},function(res){
                        if(res.status == 0){
                            layer.close(index);
                            layeralert(res.msg);
                            ...
                            window.location.href = "<?php echo App::URL('wap/user/peizi');?>" + "&pz_type=1";
                        }
                    },'json');
                });
            ...
            function moneyChange() {
                ...
                $("#accountManageFees").html(managet_cost+'元/日 共'+manager_cost_total+'元');//管理费
