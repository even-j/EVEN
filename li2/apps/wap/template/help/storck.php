                ...
                <div class="helpbox">
                    <div style="display: block;" class="hbc">
                        <dl class="hover">
                            ...
                            <dd style="padding-left:20px">b、按天策略：根据您的喜好，选择不同的策略资金和保证金比例。资金使用期限最短2天，最长30天，账户管理费在策略成功后一次性收取；策略到期默认每天自动延期，费用不足时自动终止。</dd>
                        ...
                        <dl>
                            ...
                            <dd>申请完策略后，您将获取炒股交易账号和密码，请根据提示到华亿策略会员中心下载股票交易端软件。策略炒股交易委托完全由您自己掌控。</dd>
                        </dl>
                        <dl>
                            <dt>策略利息多少，如何支付
                                <a name="QA-2-4"></a>
