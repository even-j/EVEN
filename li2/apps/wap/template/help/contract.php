...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <style>
        /*contract*/
        .contract-body{margin:20px; font-family:'Microsoft YaHei'; color:#000000; font-size:12px; line-height:130%;}
        .contract{margin:0px 0px; padding:30px 0 30px;}
    ...
    <body>
        <div class="contract-body">
            <div class="contract">
                ...
                <div class="font-bold text-left" style="font-weight:bold;">
                    甲方（委托人）：
                </div>
                <div>
                    <p>
                        华亿策略用户名：<span class="underline"><?php echo $user ['mobile'];?></span>
                    </p>
                    <p>
                        借款金额：<span class="underline"><?php echo number_format($pz_row['bond_total']*$pz_row['pz_ratio']/100);?></span>
                    </p>
                    <p>
                        借款期限： <span class="underline"><?php echo $pz_row['pz_times'];?><?php echo $pz_row['pz_times_unit']==1?'天':'月';?></span>
                    </p>
                    <p>
                        <?php if($pz_row['pz_type']==1 || $pz_row['pz_type']==4){?>
                        管理费： <span class="underline"><?php echo $pz_row['manage_cost_day']/100;?> / 天</span>
                        <?php }else{?>
                        利息： <span class="underline"><?php echo $pz_row['manage_cost_day']/100;?></span>
                        <?php }?>
                    </p>
                ...
                <div>
                    <strong style="line-height: 2.2;">丙方： 广州栋供科技有限公司</strong>
                    <br />
                    联系方式：广州市天河区科韵北路100号1楼102室  </div>
                <h2>
                    第一条 总则
                </h2>
                <p>
                    丙方是一家在广州市依法成立并有效存续的有限责任公司，拥有(www.hypz.cn)网站（下称“华亿策略”）的经营权，提供信用咨询，提供投资咨询，信息咨询服务；
                </p>
                <p>
                    2. 乙方已在华亿策略网站注册，并承诺其提供给丙方的信息是完全真实的；
                </p>
                <p>
                ...
                <table class="u-info">
                    <tr>
                        ...
                        <td>
                            ￥<?php echo number_format($pz_row['bond_total']*$pz_row['pz_ratio']/100);?>&nbsp;元
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <p>
                                <?php if($pz_row['pz_type']==1 || $pz_row['pz_type']==4){?>
                                <span class="underline"><?php echo $pz_row['manage_cost_day']/100;?> / 天</span>
                                <?php }else{?>
                                <span class="underline"><?php echo $pz_row['manage_cost_day']/100;?></span>
                                <?php }?>
                            </p>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <p>
                                ￥<?php echo number_format($pz_row['bond_total']/100);?>&nbsp;元
                            </p>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <p>
                                <?php echo date('Y年m月d日',$pz_row['start_time']);?>&nbsp;至&nbsp;<?php echo date('Y年m月d日',$pz_row['end_time']);?>
                            </p>
                        </td>
                    </tr>
                    <tr>
                ...
                <p>
                    如按照收盘价计算，乙方在某一交易日违反第4第5条约定，则乙方须在下一个交易日上午10:30前自行调整至约定比例，否则甲方有权以任何可以成交的价格完全卖出违反本条约定之类别股票。
                </p>
                <p>
                ...
                <p>
                    1、各方同意并确认，各方通过自行或授权有关方根据广州栋供科技有限公司旗下《华亿策略》有关规则和说明，在广州栋供科技有限公司旗下《华亿策略》进行委托资金申请和注册操作等方式确认签署本协议。
                </p>
                <p>
                    2、甲乙双方通过上述方式接受本协议且丙方审核通过时，本协议立即成立；协议成立的同时甲方不可撤销授权，丙方将委托资金划转至给乙方操作的股票交易账户。
                </p>
                <p>
                    3、甲方同意并授权丙方按本协议及广州栋供科技有限公司旗下《华亿策略》有关规则的约定对委托资金和相关费用进行划扣和支付，并由丙方代为收取乙方支付的有关款项。
                </p>
                <h2>
                    第四条 保证金及担保范围
                </h2>
                ...
                <p>
                    1、委托资金利率以《委托管理资金协议》约定为准，利息收取日以用户注册充值后进行策略成功之日算起。
                </p>
                <p>
                    2、委托期限：委托金额和期限以《委托管理资金协议》为准，乙方可以随时申请结算策略进行清算。
                </p>
                <p>
                    3. 利息支付方式为：<br />
                ...
                <p>
                    2、停牌股票的处理：协议账户出现停牌股票后，丙方立即冻结停牌股票市值30%的乙方保证金，直到该停牌股票开盘变现（盈亏都归乙方）再释放，剩余乙方保证金在所有未停牌股票市值的108%以上的乙方可以继续交易，达不到上述要求的乙方在三日内补足保证金，不能补足保证金的，协议终止，丙方将平仓所有未停牌股票按本条第3款结算。
                </p>

                <p>
                    3、每一笔委托到期前一个交易日，乙方应将股票交易账户的总资产全部变现为货币资金，期满当日，甲乙双方办理委托资金账户内资产的清算手续，丙方须在办理完毕清算手续的三日内将除甲方本金和应得利息之外的款项划转到乙方账户；如乙方所购股票中出现有停牌股票不能卖出， 乙方必须留存停牌股票市值30%的风险保证金，然后继续支付利息延续本协议直至停牌结束，否则甲方将按停牌前最后收盘价的70%计算乙方交易账号盈亏完成账户结算。
                </p>
                <p>
                    4、委托期满或本协议终止，甲方如未能全部收回其委托资金及利息，有权向乙方追偿，乙方除归还甲方全部委托资金和支付利息外，还应从委托期满之日起按委托资金和保证金之和的0.1%/日支付利息至甲方账户。
                </p>
                <p>
                    5、本协议因任何原因终止时，乙方应将委托人的委托资金归还给甲方，并不再使用甲方的股票交易账户进行股票交易。
                </p>
                <p>
                    6、甲乙任一方若对资金划转有异议的，可以向丙方提出异议申请，由丙方配合查询三个月内转账信息。<br />
                </p>
                <h2>
                    第七条 甲方的权利、义务及违约责任
                </h2>
