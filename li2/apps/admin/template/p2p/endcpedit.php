...
<div class="container clearfix">
    <div class="main-wrap">
    	 <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/index.php?app=admin&mod=index&ac=view" target="_top">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/index.php?app=admin&mod=p2p&ac=enccp">结束操盘</a><span class="crumb-step">&gt;</span><span><?php echo $nav_title;?></span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
             <form action="/index.php?app=admin&mod=p2p&ac=doEndcpEdit" method="post" onclick="return validateForm();" id="myform" name="myform" enctype="multipart/form-data">
                 ...
                 <table class="insert-tab" width="100%">
                    <tbody>
                        ...
                        <tr>
                            <th>倍数：</th>
                            <td id='trade_money_total'><?php echo floatval($pz_row['pz_ratio']) ?></td>
                        </tr>
                        <tr>
                            <th>补亏金额(元)：</th>
                        ...
                        <tr>
                            <th>更新时间：</th>
                            <td><?php echo empty($pz_row['update_time'])?'':date('Y-m-d H:i',$pz_row['update_time']) ?></td>
                        </tr>
                        <tr>
                            <th>总盈亏(元)：</th>
...
function goback(){
    var url = '/index.php?app=admin&mod=p2p&ac=endcp';
