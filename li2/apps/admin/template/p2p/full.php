...
<div class="container clearfix">
        ...
        <div class="search-wrap">
            <div class="search-content">
                <form action="/index.php" method="get">
                    ...
                    <input type="hidden" name="ac" value="full" >
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="status" id="status" class="common-select">
                                    ...
                                    <option <?php echo $condition['status'] == '4'?'selected="selected"':''?> value="4">未审核</option>
                                    <option <?php echo $condition['status'] == '6'?'selected="selected"':''?> value="6">已审核</option>
                                </select>
                            </td>
                            <th width="80">策略时间:</th>
                    ...
                    <table class="result-tab" style="width:100%" >
                        ...
                        <?php foreach ($list as $item){?>
                            <tr>
                                ...
                                <td><?php echo empty($item['manbiao_time'])?'':date('Y-m-d H:i',$item['manbiao_time']) ?></td>
                                <td><?php echo $item['p2pstatus']<4?'未审核':($item['p2pstatus']==4?'<span style="color:red">满标</span>':'已审核') ?></td>
    ...
    <script>
        function huabo(pz_id){
            window.location.href = '/index.php?app=admin&mod=p2p&ac=fulledit&pz_id='+pz_id;
        }
    </script>
    <!--/main-->
</div>
