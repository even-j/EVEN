...
<div class="container clearfix">
    <div class="main-wrap">
    	 <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/index.php?app=admin&mod=index&ac=view" target="_top">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/index.php?app=admin&mod=p2p&ac=full">满标审核</a><span class="crumb-step">&gt;</span><span><?php echo $nav_title;?></span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
             <form action="/index.php?app=admin&mod=p2p&ac=doFullEdit" method="post" onclick="return validateForm();" id="myform" name="myform" enctype="multipart/form-data">
                 ...
                 <table class="insert-tab" width="100%">
                    <tbody>
                        ...
                        <tr>
                            <th>满标时间：</th>
                            <td><?php echo empty($pz_row['manbiao_time'])?'':date('Y-m-d H:i',$pz_row['manbiao_time']) ?></td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>审核状态：</th>
                            <td>
                                <?php if($pz_row['p2pstatus'] <= 4){?>
...
function goback(){
    var url = '/index.php?app=admin&mod=p2p&ac=full';
