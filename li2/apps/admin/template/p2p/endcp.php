...
<div class="container clearfix">
        ...
        <div class="search-wrap">
            <div class="search-content">
                <form action="/index.php" method="get">
                    ...
                    <input type="hidden" name="ac" value="endcp" >
    ...
    <script>
        function huabo(pz_id){
            window.location.href = '/index.php?app=admin&mod=p2p&ac=endcpedit&pz_id='+pz_id;
        }
    </script>
    <!--/main-->
</div>
