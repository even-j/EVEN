        ...
        <div class="search-wrap">
            <div class="search-content">
                <form action="/index.php" method="get">
                    ...
                    <input type="hidden" name="ac" value="peizi" >
            ...
            <form name="myform" id="myform" method="post">
                <div id="div_content" class="result-content" style="width:100%;overflow: auto">
                    <table class="result-tab" style="width:100%" >
                        <tr>
                        	<th style="width: 25%;">策略用户数</th>
                        	<th style="width: 25%;">策略金额(万元)</th>
                        	<th style="width: 25%;">盈利金额(元)</th>
                            <th style="width: 25%;">日期</th>
                        </tr>
                        <?php foreach ($list as $item){?>
                            <tr>
                                <td><?php echo $item['user_count'] ?></td>
                                <td><?php echo $item['pz_money']/10000/100 ?></td>
                                <td><?php echo $item['profit_loss_money']/100 ?></td>
                                <td><?php echo $item['pz_time'] ?></td>
                            </tr>
                        <?php }?>             
                    </table>
