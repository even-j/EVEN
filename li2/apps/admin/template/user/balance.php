    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
             <form action="/index.php?app=admin&mod=user&ac=doPay" method="post" onclick="return validateForm();" id="myform" name="myform" enctype="multipart/form-data">
                        ...
                        <tbody>
                            ...
                            <tr>
                             ...
                             <tr>
	                            ...
	                            <td><select class="common-select required" id="type" name="type" style="width: 480px;">
