        ...
        <div class="result-wrap">
        		 <div class="toolbar-wrap mb10">
		            <div class="toolbar-item">
		                <a href="/index.php?app=admin&mod=user&ac=adminEdit"><i class="icon-font"></i> 添加管理员</a>
                    ...
                    <table class="result-tab" style="width:100%" >
                        ...
                        <?php foreach ($list as $item){?>
                            <tr>
                                ...
                                <td align="center">
                                    <a class="link-update" href="/index.php?app=admin&mod=user&ac=adminEdit&admin_id=<?php echo $item['admin_id'];?>">修改</a>
                                    &nbsp;&nbsp;<a class="link-del" href="javascript:delAdmin('/index.php?app=admin&mod=user&ac=delAdmin&admin_id=','<?php echo $item['admin_id'];?>');">删除</a>
                                </td>
                            </tr>
                        <?php }?>             
                    </table>
