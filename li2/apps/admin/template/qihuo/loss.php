...
<div class="container clearfix">
        ...
        <div class="search-wrap">
            <div class="search-content">
                <form action="/index.php" method="get">
                    ...
                    <input type="hidden" name="ac" value="loss" >
                    ...
                    <table class="result-tab" style="width:100%" >
                        ...
                        <?php foreach ($list as $item){?>
                            <tr>
                                ...
                                <td><?php echo floatval($item['add_loss'])/100 ?></td>
                                ...
                                <td><?php echo $item['lossstatus']==0?'<span style="color:red">未划拔</span>':'已划拔' ?></td>
                                <td><?php echo '<a href="javascript:huabo('.$item['fill_id'].')">编辑</a>' ?></td>
                            </tr>
                        <?php }?>             
                    </table>
    ...
    <script>
        function huabo(fill_id){
            window.location.href = '/index.php?app=admin&mod=qihuo&ac=lossedit&fill_id='+fill_id;
        }
    </script>
    <!--/main-->
</div>
