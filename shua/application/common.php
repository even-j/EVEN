...
/**
    ...
    function getShopType($ac=1){
         if($ac==1){
             $arr = [
                 1=>'淘宝',
                 2=>'天猫',
                 3=>'陶特','4'=>'拼多多','5'=>'抖音','6'=>'京东'
             ];
         }elseif($ac ==2){
             $arr = [
                 ...
                 4=>'/static/seller/img/pinduoduo.png',
                 5=>'/static/seller/img/douyin.png',
                 6=>'/static/seller/img/jingdong.png'
             ];
         }elseif($ac ==3){
            $arr = [
                '淘宝'=>'/static/seller/img/taobao.png',
                '天猫'=>'/static/seller/img/tianmao.png',
                '陶特'=>'/static/seller/img/feizhu.png',
                '拼多多'=>'/static/seller/img/pinduoduo.png',
                '抖音'=>'/static/seller/img/douyin.png',
                '京东'=>'/static/seller/img/jingdong.png'
            ];
        }
