    ...
    public function index(Request $request)
    {
        if (request()->isAjax()) {
            ...
            foreach ($list as $k => &$v) {
                ...
                $commission = Db::name('commission')->where('type',$v['type'])
...
//                }
    ...
    public function maketask()
    {
        $have_task = Db::name('user_task')
            ->field('b.id,a.type,b.task_type,b.seller_id,b.state,b.terminal,a.user_divided,a.id,a.principal,a.commission,a.user_buyno_wangwang,a.seller_task_id,a.task_step,a.is_ys')
            ->alias('a')
...
//        }
    ...
    public function confirm_refund(){
        ...
        if(empty($refund_task)){
            ...
            $value=4;
            return $this->success('返佣成功',url('My/index',['value'=>$value]));
        }
    }
    //买手确认一键返款数据
